    ...
    <div class="row ansicht-picture">
      <div class="container">    
        ...
        <div class="row ansicht-details-aktion">
          ...
          <?php endif; ?>
          <?php if ($logged_in == 1): ?>
            <i class="material-icons">collections</i> <?php print render($content['links']['flag']); ?>
          <?php else : ?>


            <i class="material-icons">collections</i> <a data-toggle="modal" data-target="#collection-modal" class="ansicht-collection-button-message"> in meine Sammlung</a>

            <!-- Modal -->
            <div class="modal fade" id="collection-modal" role="dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Zum Anlegen einer Bildersammlung bitte <a href="/user/login">ANMELDEN</a> oder <a href="/user/register">REGISTRIEREN</a></p>
                </div>
